...
import { deletePrompt, updatePrompt } from '../../store/promptSlice';
            ...
            {isEditing ? (
                ...
                <>
                    <div className="absolute top-2 right-2 flex items-center space-x-2">
                        <button
                            onClick={handleEdit}
                            className="p-1.5 rounded-full bg-gray-100 hover:bg-blue-100 focus:outline-none"
                            title="Edit Prompt"
                        >
                            <PencilSquareIcon className="w-5 h-5 text-gray-500 hover:text-blue-500 transition-colors" />
                        </button>
